export function PageHeader({
  ...
  return (
    <header className="border-b border-slate-200/90 bg-[#f7f8fa]">
      <div className="mx-auto flex w-full max-w-[1680px] flex-col gap-5 px-5 py-8 sm:px-8 lg:flex-row lg:items-end lg:justify-between lg:px-10 lg:py-10 2xl:px-12">
